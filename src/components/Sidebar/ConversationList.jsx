...
const ConversationItem = ({ id, title, preview, date, category, searchQuery = '', onDelete }) => {
  const handleDelete = (e) => {
    e.stopPropagation(); // Empêche le déclenchement du clic sur la conversation
    onDelete(id);
  };
...
const ConversationList = ({ conversations, searchQuery = '', onDelete }) => {
  return (
